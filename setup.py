...
description = "egsnrc2py is a transpiler to convert EGSnrc code to Python"
...
URL = "https://github.com/darcymason/egsnrc2py"
REQUIRES = []
...
with open(BASE_PATH / "egsnrc2py" / "_version.py", 'r') as f:
    exec(f.read())
